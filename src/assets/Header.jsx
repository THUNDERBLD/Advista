                ...
                <nav className="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8" aria-label="Global">
                    <div className="flex lg:flex-1">
                        <a href="" className="-m-1.5 p-1.5">
                            <span className="sr-only">Advista</span>
                            <img className="h-10 w-auto rounded-full" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR6wN66SELW_vxFFWDzJDuB5mFnhSNvgDAzag&s" alt="" />
                        </a>
                    </div>
                    ...
                    <div className="hidden lg:flex lg:gap-x-12">
                        <div className="relative">
                            <button type="button" className="text-md flex items-center gap-x-1 font-semibold leading-6 text-gray-900" aria-expanded="false">
                                Product
                        ...
                        <a href="#" className="text-md font-semibold leading-6 text-gray-900">Features</a>
                        <a href="#" className="text-md font-semibold leading-6 text-gray-900">Marketplace</a>
                        <a href="#" className="text-md font-semibold leading-6 text-gray-900">Company</a>
                    </div>
                            ...
                            <div className="-my-6 divide-y divide-gray-500/10">
                                <div className="space-y-2 py-6">
                                    <div className="-mx-3">
                                        ...
                                        <div className="mt-2 space-y-2 bar" id="disclosure-1">
